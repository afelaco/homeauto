...
async def async_setup_entry(hass: HomeAssistant, config_entry, async_add_entities):
    ...
    platform.async_register_entity_service(SERVICE_VTO_CANCEL_CALL, {}, "async_vto_cancel_call")
    ...
    platform.async_register_entity_service(
        SERVICE_SET_DAY_NIGHT_MODE,
        {
            ...
            vol.Required("mode"): vol.In(
                ["color", "Color", "brightness", "Brightness", "blackwhite", "BlackWhite", "Auto", "auto"]
            ),
        },
...
class DahuaCamera(DahuaBaseEntity, Camera):
    ...
    async def async_set_service_set_text_overlay(self, group: int, text1: str, text2: str, text3: str, text4: str):
